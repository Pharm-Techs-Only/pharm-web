...
const Layout = ({ children, includeHeader = false, includeCTA = false }) => {
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="-right-[60px] top-[3805px] absolute z-10"><img src={circlesRight} alt="Circles" /></div>
      <div className="-left-[60px] top-[4445px] absolute z-10"><img src={circlesLeft} alt="Circles" /></div>
