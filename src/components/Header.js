...
const Header = () => {
  ...
  const navLinks = (mobile = false) => (
    <>
      <Link 
        to="/#waitlist" 
        className={`text-pharm-light-blue ${mobile ? 'text-center' : ''} hover:text-pharm-blue px-3 py-2 text-sm font-[18px] transition-colors`}
      ...
      <a 
        ...
        className={`text-pharm-light-blue ${mobile ? 'text-center' : ''} hover:text-pharm-blue active:text-pharm-blue px-3 py-2 text-sm font-[18px] transition-colors`}
        activeClassName="text-pharm-blue"
      >
        Careers
      </a>
