          ...
          <div className="pt-[60px] md:pt-[80px] lg:py-[120px] xl:pt-[170px] w-[100%] lg:w-[50%] pl-0 lg:pl-[120px]">
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-12">
                <a href="https://www.facebook.com/4PharmTechsOnly" target="_blank" className="text-white bg-white hover:bg-gray-200 transition-colors">
                ...
                <a href="https://www.instagram.com/pharmtechsonly" target="_blank" className="text-white bg-white hover:bg-gray-200 transition-colors">
                ...
                <a href="https://www.linkedin.com/company/pharmtechsonly" target="_blank" className="text-white bg-white hover:bg-gray-200 transition-colors">
