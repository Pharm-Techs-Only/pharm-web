...
import heroContact from '../assets/images/hero_contact.svg'
    ...
    <Layout>
      ...
      <HeroHeader>
        ...
        <div className="flex justify-center w-[100%] md:w-[70%] lg:w-[50%] relative px-12">
          <img src={heroContact} alt="Contact Us" className="lg:!absolute -bottom-[20px]" />
        </div>
      </HeroHeader>
      ...
      <section className="relative pb-[60px] lg:pb-[160px]">
        ...
        </div><div className="w-full left-[0] bottom-[0] absolute z-10"><img src={cloudFloor} alt="Cloud Floor" className="w-full" /></div>
      </section>
