      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Accuracy of Website Content</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Copyright and Trademarks</h2>
            <p className="text-pharm-grey mb-4">
            ...
            <p className="text-pharm-grey mb-4">
              No Content from the Website or Services may be captured, reproduced, transferred, sold, licensed, removed, deleted, augmented, published, transmitted, uploaded, reverse engineered, edited, posted, publicly displayed, linked, broadcast, or distributed or exploited by any other means, unless otherwise expressly permitted in these Terms or in writing by us. <strong>ANY DISTRIBUTION FOR COMMERCIAL PURPOSES IS STRICTLY PROHIBITED WITHOUT OBTAINING A LICENSE TO DO SO FROM US OR OUR LICENSORS OR UNLESS EXPLICITLY PERMITTED BY THESE TERMS.</strong> If you copy, reproduce, or retransmit any part of our Website or Services in breach of these Terms, your right to use our Website and Services will cease immediately and you must, at our option, return, destroy, or recall any copies of the Content you have made.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">DMCA Notice</h3>
            <p className="text-pharm-grey mb-4">
            ...
            <p className="text-pharm-grey mb-4">All notices should be addressed to the contact person specified below (our agent for notice of claimed infringement):</p>
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <p className="text-pharm-grey">
                <strong>Notification of Claimed Infringement:</strong><br />
                PharmTechsOnly.com<br />
                1349 Lynn Ave #118<br />
                Bethlehem, PA 18015<br />
                Agent's Name/Email Address: questions@pharmtechsonly.com<br />
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Prohibitions and Rights</h2>
            <p className="text-pharm-grey mb-4">
            ...
            <ul className="list-disc pl-6 text-pharm-grey mb-4 space-y-2">
              <li>Use, display, mirror, or frame the Website or any individual element within the Website, including our name(s);</li>
              <li>Access, tamper with, or use non-public areas of the Website – e.g. our computer systems, etc.;</li>
              <li>Attempt to probe, scan, or test the vulnerability of any of our systems or networks;</li>
              <li>Breach any security or authentication measures;</li>
              <li>Avoid, bypass, remove, deactivate, impair, descramble, or otherwise circumvent any technological measure implemented by us, any of our providers, or any other third party – e.g. other users, etc.;</li>
              <li>Attempt to access or search the Website through the use of any engine, software, tool, agent, device, or mechanism – e.g. spiders, robots, crawlers, data mining tools, etc. – other than the software and/or search agents provided by us;</li>
              ...
              <li>Use any meta tags or other hidden text;</li>
              <li>Use any metadata utilizing our trademark or URL;</li>
              <li>Forge any TCP/IP packet header or any part of the header information in any email or posting;</li>
              <li>Use the Website in any way to send altered, deceptive, or false source-identifying information;</li>
              <li>Attempt to decipher, decompile, disassemble, or reverse engineer any of the software used, contained, or displayed within the Website or Services;</li>
              <li>Interfere with or attempt to interfere with the access of any user, host, or network – e.g. sending a virus, overloading, flooding, spamming, mail-bombing, etc.;</li>
              <li>Collect or store any Personal Information from other users of the Website or Services;</li>
              <li>Impersonate or misrepresent your affiliation with any person or entity;</li>
              <li>Access the Website behind proxy servers or URL cloaking techniques; and/or</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Use of Communication Services</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. User Submissions to Communications Services</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Pharmacy Technicians</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Prospective Employers</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">11. General Marketplace Terms, Account Creation, and Community Guidelines</h2>
            <p className="text-pharm-grey mb-4">
            ...
            <ul className="list-disc pl-6 text-pharm-grey mb-4 space-y-2">
              ...
              <li>Help keep one another safe</li>
              <li>Comply with all applicable laws and regulations</li>
              <li>Do not touch anyone without their consent</li>
              <li>Never hurt anyone</li>
              <li>Sexual assault and misconduct is strictly prohibited</li>
              <li>Never threaten anyone in connection with the Services</li>
              <li>Discrimination of any kind is prohibited in connection with the Services</li>
              <li>You are responsible for any property damage caused to third-parties</li>
              <li>Account sharing is not allowed</li>
              <li>You are responsible to confirm the identify of anyone you meet through the Services</li>
              <li>You are prohibited from using drugs or alcohol while meeting with others via the Services</li>
              <li>You will not cause a nuisance, annoyance, or inconvenience to others in using the Services</li>
            </ul>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">12. Online Store</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">13. Marketing Affiliates</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-pharm-grey mb-4 space-y-2">
              <li>Personal or bodily injury, death, emotional distress, or property damage;</li>
              <li>Interactions or meetings with other users of the Website, Services, or Content or other persons with whom you communicate or interact with as a result of your use of the Website, Services, or Content;</li>
              <li>Loss or corruption of data, lost communications, or any other loss or damage of any kind arising from any telecommunication services and internet services or the failure of such services that you use to access or use the Website, Services, or Content; and</li>
              <li>Any other Claims arising out of or relating to your acts or omissions or the acts or omissions of any third party, whether in contract, warranty, strict liability, negligence, or other legal theory regardless of whether or not we have been informed of the possibility of such Claims, even if a limited remedy set forth herein is found to have failed of its essential purpose.</li>
            </ul>
            <p className="text-pharm-grey mb-4">
            ...
            <p className="text-pharm-grey mb-4">
              <strong>ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THESE TERMS OR THE PRODUCTS OR SERVICES OFFERED BY US MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES, OTHERWISE, SUCH CAUSE OF ACTION OR CLAIM IS PERMANENTLY BARRED.</strong>
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-pharm-grey mb-4 space-y-2">
              <li>Your access to or use of the Website, Services, or Content, including your violation of these Terms;</li>
              <li>Any goods or services or information you may provide or fail to provide; and</li>
              <li>Any agreements or understandings you have with third parties.</li>
            </ul>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">18. Disputes and Claims</h2>
            <p className="text-pharm-grey mb-4">
            ...
            <p className="text-pharm-grey mb-4">
              Any arbitration under these Terms of Service will take place on an individual basis; class arbitrations and class/representative/collective actions are not permitted. <strong>THE PARTIES AGREE THAT A PARTY MAY BRING CLAIMS AGAINST THE OTHER ONLY IN EACH'S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PUTATIVE CLASS, COLLECTIVE AND/ OR REPRESENTATIVE PROCEEDING, SUCH AS IN THE FORM OF A PRIVATE ATTORNEY GENERAL ACTION AGAINST THE OTHER.</strong> Further, unless both you and Pharm Techs Only agree otherwise, the arbitrator may not consolidate more than one person's claims, and may not otherwise preside over any form of a representative or class proceeding.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">19. Controlling Law</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">20. Notice to International Visitors</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">21. Privacy</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">22. Changes to Terms</h2>
            <p className="text-pharm-grey mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">23. Notices</h2>
            <p className="text-pharm-grey mb-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              <p className="text-pharm-grey">
                ...
                1349 Lynn Ave #118<br />
                Bethlehem, PA 18015<br />
                questions@pharmtechsonly.com<br />
                484-861-7000
              </p>
            </div>
            <p className="text-pharm-grey mb-4">
